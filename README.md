...
There is a broader platform CI testing for Linux _x86_ (32/64bit), _ARM_, _PowerPC_ (32/64bit) and NetBSD _x86_ (32/64bit) [using buildbot](http://build.myriabit.eu:8011/waterfall). 

Tested machine architectures include _x86_ (32/64bit), _ARM_, _PowerPC_
(32/64bit) and UltraSPARC (32/64bit).
